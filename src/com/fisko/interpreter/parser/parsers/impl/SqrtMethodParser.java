...
import com.fisko.interpreter.parser.interpret.impl.SqrtMethod;
import com.fisko.interpreter.parser.parsers.Parser;

import java.util.List;

public class SqrtMethodParser extends Parser {

    private static final Token METHOD_TOKEN = new Token("Math.sqrt");
    ...
    private ParserResult parseUnsafe(List<Token> tokens) {
        ...
        SqrtMethod method = new SqrtMethod(expression);
